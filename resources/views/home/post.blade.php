            ...
            <div class="row">
                <div class="col-md-6 mb-md-0 mb-sm-3">
                    <figure class="mb-0 mt-lg-0 mt-3 border-radius-5">
                        <img class=" border-radius-5" src="{{ $post->image }}" alt="">
                    </figure>
                </div>
                <div class="col-md-6 align-self-center">
                    <div class="post-content">
                        <div class="entry-meta meta-0 mb-15 font-small">
                            <a href="category.html"><span class="post-cat position-relative text-info">{{ $post->category->title }}</span></a>
                        </div>
                        ...
                        <div class="entry-meta align-items-center meta-2 font-small color-muted">
                            <p class="mb-5">
                                <a class="author-avatar" href="#"><img class="img-circle" src="{{ asset('assets') }}/imgs/authors/default-user.png" alt=""></a>
                                By <a href="author.html"><span class="author-name font-weight-bold">{{ $post->author->name }}</span></a>
                            </p>
                            <span class="mr-10"> {{ \Carbon\Carbon::parse($post->created_at)->format('d F Y') }}</span>
                            <span class="has-dot"> {{ round(strlen($post->content)/180) }} mins read</span>
                        </div>
                    </div>
                </div>
        ...
        <article class="entry-wraper mb-50">
            ...
            <div class="entry-bottom mt-50 mb-30 wow fadeIn animated">
                <div class="tags">
                    ...
                    <a href="{{ route('home.search',$tag) }}" rel="tag">{{ $tag }}</a>
                    @endforeach
                </div>
            </div>
            <div class="single-social-share clearfix wow fadeIn animated">
                <div class="entry-meta meta-1 font-small color-grey float-start mt-10">
                    ...
                    <span class="hit-count mr-15"><i class="elegant-icon icon_like mr-5"></i>{{ $post->likes }} likes</span>
                    <span class="hit-count"><i class="elegant-icon icon_star-half_alt mr-5"></i>Rate: {{ $post->like_rate }}</span>
                </div>
